  ...
  return !loading ? (
    !hotels || hotels.length === 0 ? (
      ...
      <div className="flex fixed overflow-hidden w-full flex-col items-center bg-[url('./assets/desert.jpg')] bg-cover" style={{
        ...
        <ul className="max-w-lvh m-6 divide-y dark:divide-transparent divide-black  flex flex-col">
          {hotels.map((hotel, index) => (
            <li key={index} className="pb-3 sm:pb-4 ">
              <div className="flex items-center space-x-4 rtl:space-x-reverse dark:bg-gray-900 mx-auto dark:border-gray-700 h-auto p-7 rounded-2xl">
                <div className="flex-1 min-w-0">
                  <p className="text-xl font-medium text-gray-900 truncatetext-gray-900 dark:text-white">
                    {hotel.hotel.name}
                  </p>
                  <p className="text-smtext-gray-900 dark:text-white truncate dark:text-gray-400">
